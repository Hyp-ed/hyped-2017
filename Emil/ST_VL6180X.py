...
class VL6180X:
    ...
    __VL6180X_SYSRANGE_RANGE_CHECK_ENABLES          = 0xFFFF #2d
    ...
    __VL6180X_RESULT_RANGE_VAL                      = 0x0062 #0062
    ...
    __VL6180X_READOUT_AVERAGING_SAMPLE_PERIOD       = 0x010A #look 10a
    ...
    def get_distance(self):
        ...
        if self.debug:
            print "Range status: %x" % \
                  self.get_register(self.__VL6180X_RESULT_RANGE_STATUS) #used to be & 0xF1
